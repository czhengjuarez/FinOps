...
const AITravelOptimizer = ({ estimateData }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-lg border-2 border-purple-200 dark:border-purple-900 p-6">
