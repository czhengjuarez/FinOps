...
var index_default = {
  async fetch(request, env, ctx) {
    ...
    if (!env.__STATIC_CONTENT) {
      return new Response("Static content not configured. Please use Cloudflare Pages or configure Workers Sites properly.", {
        status: 500,
    ...
    try {
      return await getAssetFromKV(
        ...
        },
        {
          ...
          mapRequestToAsset: /* @__PURE__ */ __name((req) => {
            ...
            if (!url2.pathname.includes(".")) {
              url2.pathname = "/index.html";
            }
            return new Request(url2.toString(), req);
          }, "mapRequestToAsset")
        }
      );
    } catch (e) {
      try {
        ...
        return new Response(`Asset not found: ${e.message}`, {
          status: 404,
          headers: { "Content-Type": "text/plain" }
        });
      }
